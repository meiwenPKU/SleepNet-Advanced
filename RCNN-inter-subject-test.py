'''
test RCNN for inter-subject sleep stage classification
'''
import numpy as np
...
model.compile(loss='categorical_crossentropy', optimizer=optimizers.Adam(lr=0.0001, decay=0.0001), metrics=['accuracy'])
