'''
test RNN for inter-subject sleep stage classification
'''
import numpy as np
...
test_gen = generator(lookback=lookback, min_index=5201, max_index=None, batch_size=batch_size, step=step)
